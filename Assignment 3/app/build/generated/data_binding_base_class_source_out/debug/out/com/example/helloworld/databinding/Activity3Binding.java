...
public final class Activity3Binding implements ViewBinding {
  ...
  private Activity3Binding(@NonNull RelativeLayout rootView, @NonNull ScrollView scrollView1) {
  ...
  public static Activity3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Activity3Binding((RelativeLayout) rootView, scrollView1);
    }
